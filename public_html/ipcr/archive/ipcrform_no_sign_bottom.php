...
if ($idnumber !== null) {
    ...
    // Set the variable to null regardless of the fetched data
...
if ($idnumber !== null && $semester_id !== null) {
    ...
    // Set the variables to null regardless of the fetched data
...
if ($idnumber && $semester_id) {
    ...
    if ($check_stmt->num_rows > 0) {
        ...
        // Set the signature data and created_at to null regardless of the fetched data
        $signature_data_vpaaqa = null; // Override with null
        $vpaa_final_sign_created = null; // Override with null
    } else {
        // If no rows were returned, set the signature data and created_at to null
        $signature_data_vpaaqa = null;
        $vpaa_final_sign_created = null; // Also set created_at to null
    }
...
if ($idnumber && $semester_id) {
    ...
    if ($check_stmt->num_rows > 0) {
        ...
        // If no rows were returned, set the variables to null
...
if ($finalSignatureExists) {
    ...
    // Set the signature data and created_at to null regardless of the fetched data
    $signature_data_office_head_final = null; // Override with null
    $dean_final_sign_created_at = null; // Override with null
} else {
    // If the record does not exist, set the signature data to null
...
if ($signature_data_office_head_final === null) {
    ...
    // Handle the case where the College Dean's signature is found
}
