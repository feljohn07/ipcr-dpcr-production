...
$sql = "SELECT * FROM first_vpaa_to_ipcr_ofdeansignature WHERE idnumber = ? AND semester_id = ?";
...
if ($result->num_rows > 0) {
    ...
    $delete_sql = "DELETE FROM first_vpaa_to_ipcr_ofdeansignature WHERE idnumber = ? AND semester_id = ?";
    ...
    $insert_sql = "INSERT INTO first_vpaa_to_ipcr_ofdeansignature (idnumber, semester_id, signature_created_at) VALUES (?, ?, ?)";
