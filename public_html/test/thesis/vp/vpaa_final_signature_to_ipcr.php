...
$sql = "SELECT * FROM vpaa_to_ipcr_finalsign WHERE idnumber = ? AND semester_id = ?";
...
if ($result->num_rows > 0) {
    ...
    $delete_sql = "DELETE FROM vpaa_to_ipcr_finalsign WHERE idnumber = ? AND semester_id = ?";
    ...
    $insert_sql = "INSERT INTO vpaa_to_ipcr_finalsign (idnumber, semester_id, signature_created_at) VALUES (?, ?, ?)";
