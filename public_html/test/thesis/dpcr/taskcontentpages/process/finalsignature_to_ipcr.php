...
$sql = "SELECT * FROM for_ipcr_final_signature WHERE idnumber = ? AND semester_id = ?";
...
if ($result->num_rows > 0) {
    ...
    $delete_sql = "DELETE FROM for_ipcr_final_signature WHERE idnumber = ? AND semester_id = ?";
    ...
    $insert_sql = "INSERT INTO for_ipcr_final_signature (idnumber, semester_id, signature_created_at) VALUES (?, ?, ?)";
