...
// Query to fetch data
$sql = "SELECT semester_id, semester_name, office_head_id, college, created_at, pres_is_read FROM semester_task_logs ORDER BY created_at DESC";
    ...
    <div class="notification-container">
        ...
        if (count($notifications) > 0) {
            foreach ($notifications as $notification) {
                ...
                $bgColor = $notification["pres_is_read"] == 0 ? '#d3d3d3' : '#fff'; // Gray for unread, white for read
