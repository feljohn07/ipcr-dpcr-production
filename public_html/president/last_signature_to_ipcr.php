...
$sql = "SELECT * FROM president_final_signature_to_ipcr WHERE idnumber = ? AND semester_id = ?";
...
if ($result->num_rows > 0) {
    ...
    $delete_sql = "DELETE FROM president_final_signature_to_ipcr WHERE idnumber = ? AND semester_id = ?";
    ...
    $insert_sql = "INSERT INTO president_final_signature_to_ipcr (idnumber, semester_id, signature_created_at) VALUES (?, ?, ?)";
