        ...
        <table class="review-table">
            ...
            <tbody>
                <?php
                    ...
                    <tr>
                        <td colspan="6" style="text-align: right;"><span>Final Average Rating (O, VS, S, US, OR
                                P)</span></td>
                        <td>
                            <?php
        ...
        <table class="review-table">
            ...
            <td class="for-signature" style="position: relative; padding: 0; height: 140px; width: 190px; overflow: hidden; border-bottom: none;">
                ...
                <td rowspan="3" style="padding: 0; margin: 0; vertical-align: top; text-align: center; width: 100px;"> <!-- Set vertical-align to top and text-align to center -->
                    ...
                    <?php 
                        // Ensure variables are initialized
                        $vpaa_final_sign_created = $vpaa_final_sign_created ?? null; // Fallback to null if undefined
                        $dean_final_sign_created_at = $dean_final_sign_created_at ?? null; // Fallback to null if undefined

                        // Check the user's designation
                        if ($designation === 'Dean') {
                            // Use $vpaa_final_sign_created when the designation is Dean
                            $created_at = $vpaa_final_sign_created;
                        } else {
                            // Use $dean_final_sign_created_at when the designation is not Dean
                            $created_at = $dean_final_sign_created_at;
                        }
