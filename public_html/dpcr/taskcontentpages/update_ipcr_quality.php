...
$message = 'Dean rated Quality: ' . $new_quality . " for the Submitted Document" . '<br>Task Type: ' . $task_type . '<br><br>Task Name:<br>' . $task_name . '<br><br>Task Description<br>' . $task_description;
