    ...
    <button id="back-button" type="button" style="background-color: green; color: white; border: none; border-radius: 5px; cursor: pointer; font-size: 16px; position: fixed; right: 20px; top: 20px; z-index: 1000;" onclick="goBack()">Back</button>
        ...
        <fieldset>
            ...
            <div class="task-box">
                ...
                <input type="text" name="semester_name" value="<?php echo htmlspecialchars($semester['semester_name']); ?>" required>

                <label for="start_date">Start Date:</label>
                <input type="date" name="start_date" value="<?php echo htmlspecialchars($semester['start_date']); ?>" required>

                <label for="end_date">End Date:</label>
                <input type="date" name="end_date" value="<?php echo htmlspecialchars($semester['end_date']); ?>" required>

                <label for="college">College:</label>
                <input type="text" name="college" value="<?php echo htmlspecialchars($semester['college']); ?>" readonly>
            </div>
        </fieldset>
        ...
        <fieldset>
            ...
            <div id="strategic-tasks-container">
                ...
                <div class="task-box" id="task-box-<?php echo $task['task_id']; ?>">
                    ...
                    <textarea name="strategic_task_name[]" id="strategic_task_name_<?php echo $task['task_id']; ?>" rows="4" required><?php 
                    ...
                    <textarea name="strategic_description[]" id="strategic_description_<?php echo $task['task_id']; ?>" rows="4" required><?php 
                        // First remove any escape characters using stripslashes()
                    ...
                    <input type="date" name="strategic_due_date[]" id="strategic_due_date_<?php echo $task['task_id']; ?>" value="<?php echo htmlspecialchars($task['due_date']); ?>" required>
                    <label for="strategic_documents_required_<?php echo $task['task_id']; ?>">Documents Required:</label>
                    <input type="number" name="strategic_documents_required[]" id="strategic_documents_required_<?php echo $task['task_id']; ?>" value="<?php echo htmlspecialchars($task['documents_req']); ?>" min="0" required>
                    <button type="button" onclick="confirmDelete('<?php echo $task['task_id']; ?>', 'strategic')">Delete</button>
                </div>
                <?php endforeach; ?>
            </div>
        ...
        <fieldset>
            ...
            <div id="core-tasks-container">
                ...
                <div class="task-box" id="task-box-<?php echo $task['task_id']; ?>">
                    <textarea name="core_task_name[]" id="core_task_name_<?php echo $task['task_id']; ?>" rows="4" required><?php 
                        // First remove any escape characters using stripslashes()
                        $task_name = stripslashes($task['task_name']);
                    ...
                    <textarea name="core_description[]" id="core_description_<?php echo $task['task_id']; ?>" rows="4" required><?php 
                        // First remove any escape characters using stripslashes()
                        $description = stripslashes($task['description']);
                    ...
                    <input type="date" name="core_due_date[]" id="core_due_date_<?php echo $task['task_id']; ?>" value="<?php echo htmlspecialchars($task['due_date']); ?>" required>
                    <label for="core_documents_required_<?php echo $index; ?>">Documents Required:</label>
                    <input type="number" name="core_documents_required[]" id="core_documents_required_<?php echo $index; ?>" value="<?php echo htmlspecialchars($task['documents_req']); ?>" min="0" required>
                    <button type="button" onclick="confirmDelete('<?php echo $task['task_id']; ?>', 'core')">Delete</button>
                </div>
                <?php endforeach; ?>
            </div>
        ...
        <fieldset>
            ...
            <div id="support-tasks-container">
                ...
                <div class="task-box" id="task-box-<?php echo $task['task_id']; ?>">
                    <textarea name="support_task_name[]" id="support_task_name_<?php echo $task['task_id']; ?>" rows="4" required><?php 
                        // First remove any escape characters using stripslashes()
                        $task_name = stripslashes($task['task_name']);
                    ...
                    <textarea name="support_description[]" id="support_description_<?php echo $task['task_id']; ?>" rows="4" required><?php 
                        // First remove any escape characters using stripslashes()
                        $description = stripslashes($task['description']);
                    ...
                    <input type="date" name="support_due_date[]" id="support_due_date_<?php echo $task['task_id']; ?>" value="<?php echo htmlspecialchars($task['due_date']); ?>" required>
                    <label for="support_documents_required_<?php echo $index; ?>">Documents Required:</label>
                    <input type="number" name="support_documents_required[]" id="support_documents_required_<?php echo $index; ?>" value="<?php echo htmlspecialchars($task['documents_req']); ?>" min="0" required>
                    <button type="button" onclick="confirmDelete('<?php echo $task['task_id']; ?>', 'support')">Delete</button>
                </div>
                <?php endforeach; ?>
            </div>
